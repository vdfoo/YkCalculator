...
namespace YkCalculator.Logic
{
    public class F35_1 : FormulaBase, IFormula
    {
        public Output Calculate(Input input)
        {
            ...
            result.HargaCincin = Math.Round(input.HargaCincin * 1.6 * result.Keping, 2);
            ...
            result.DetailedBreakdown += GetDetailBreakdown(result, result.UpahKainA, result.HargaCincin, result.UpahButang, result.HargaKainA, 
                result.HargaKainB + result.HargaTaliLangsir);
