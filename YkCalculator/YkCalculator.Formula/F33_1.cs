...
namespace YkCalculator.Logic
{
    public class F33_1 : FormulaBase, IFormula
    {
        public Output Calculate(Input input)
        {
            ...
            result.HargaKainB = Math.Round((input.Tinggi + 15) / 39.0 * input.HargaKainB * result.Keping / 2, 2);
            ...
            result.Jumlah = Math.Round(result.UpahKainA + result.HargaKainA + result.UpahKainB + result.HargaKainB + result.UpahButang + result.UpahCincin, 2);
