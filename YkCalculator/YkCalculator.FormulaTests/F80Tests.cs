...
namespace YkCalculator.Logic.Tests
{
    ...
    public class F80Tests
    {
        ...
        public void CalculateTest()
        {
            ...
            ReadyMadeProduct p1 = new ReadyMadeProduct("1 Panel Bunga", "27'' x 84", 125);
            p1.Quantity = 2;

            ReadyMadeProduct p2 = new ReadyMadeProduct("1 Panel Kosong", "27'' x 96", 125);
            p2.Quantity = 2;

            ReadyMadeProduct p3 = new ReadyMadeProduct("2 Panel", "51'' x 84", 175);
            p3.Quantity = 2;

            ReadyMadeProduct p4 = new ReadyMadeProduct("3 Panel", "75'' x 84", 235);
            p4.Quantity = 2;
